...
/*   Updated: 2024/03/15 00:05:57 by misidori         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << std::endl;
	std::cout << GREEN << get_name() << " is now in gatekeeper mode and can't be attacked." << RESET << std::endl;
	std::cout << std::endl;
}
...
{
	std::cout << std::endl;
	std::cout << GREEN << get_name() << " attacks " << target << " with a 619! " << get_damage() << " points!" << RESET << std::endl;
	std::cout << std::endl;
}
